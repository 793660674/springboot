...
public class QrcodeUtil {
    ...
    {  
    	String qrlogoUrl = "/Users/fuyue/Downloads/db/123.png";
//    	String qrlogoUrl = "http://www.xueduoduo.com/img/logo.png";
    	String qrSavePath = "/Users/fuyue/Downloads/db/";
        try  
        {  
            String ret = getLogoQRCode("https://www.xueduoduo.com/",qrlogoUrl,qrSavePath, "跳转到学多多的二维码");
//          String ret = getLogoQRCode("https://www.xueduoduo.com/",qrSavePath, "跳转到学多多的二维码");
     ...
     *
     * @param qrPic			二维码网址
     * @param qrlogoUrl		二维码上logo的网址
     * @param localPath		二维码保存地址
     * @param productName	二维码上显示的名称
     * 
     */
    public static String getLogoQRCode(String qrUrl,String qrlogoUrl,String localPath,String productName)
    {
        //filePath是二维码logo的路径，但是实际中我们是放在项目的某个路径下面的，所以路径用上面的，把下面的注释就好
        String filePath = qrlogoUrl; //"/Users/fuyue/Downloads/xue.png"; 
        String content = qrUrl;
        
        try
        {  
            if (StringUtil.isNotEmpty(qrlogoUrl) && qrlogoUrl.startsWith("http")){
            	filePath = FileUtil.downloadNet(qrlogoUrl, localPath);
     ...
     * 
     */
    public static String getLogoQRCode(String qrUrl,String localPath,String productName)
    {
        String content = qrUrl;
        try
        {  
        	QrcodeUtil zp = new QrcodeUtil();
            BufferedImage bim = zp.getQR_CODEBufferedImage(content, BarcodeFormat.QR_CODE, 400, 400, zp.getDecodeHintType());
            return zp.addLogo_QRCode(bim, null, new LogoConfig(), productName, localPath);
        }
        catch (Exception e)
        {
            e.printStackTrace();
     ...
     * @param logoPic
     */
    private String addLogo_QRCode(BufferedImage bim, File logoPic, LogoConfig logoConfig, String productName, String qrSavePath)
    {
        try
        {
            /**
            ...
            if (StringUtil.isNotEmpty(logoPic)){
	            /**
	             * 读取Logo图片
	             */
...
//                  outg.drawString(productName, 0, image.getHeight() + (outImage.getHeight() - image.getHeight())/2 + 5 ); //画文字
            ...
            File qrfile = new File(qrSavePath + new Date().getTime() + "xueduoudo.png");
